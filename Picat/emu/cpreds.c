...
/*ML component*/
extern int c_ML_PREDICT();
extern int c_ML_PREDICT_DETAILED();
extern int c_ML_CONNECT();
extern int c_ML_DISCONNECT();
/*
...
void Cboot() {
    /*ML component - Enhanced with GNN support*/
    insert_cpred("c_ML_PREDICT", 4, c_ML_PREDICT);
    insert_cpred("c_ML_PREDICT_DETAILED", 5, c_ML_PREDICT_DETAILED);
    insert_cpred("c_ML_CONNECT", 1, c_ML_CONNECT);
    insert_cpred("c_ML_DISCONNECT", 0, c_ML_DISCONNECT);
    /***************/
