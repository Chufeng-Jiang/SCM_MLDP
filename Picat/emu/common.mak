OBJ = dis.o init.o init_sym.o loader.o inst_inf.o main.o toam.o unify.o \
	...
	picat_utilities.o ml_ext.o fann.o fann_cascade.o fann_error.o fann_io.o fann_train.o fann_train_data.o fann_interface.o
...
ml_ext.o : ml_ext.c term.h basic.h bapi.h
	$(CCC) $(CFLAGS) ml_ext.c
